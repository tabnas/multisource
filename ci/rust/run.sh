...
for SIBLING in parser json jsonic directive support path debug; do
...
# exemption: the recorded version of each sibling path crate. Those entries
...
# in rs/README.md passes a gate that only runs it.
"${CARGO[@]}" test --doc
