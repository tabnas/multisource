...
//
// libtabnasmultisource is the multisource format parser as a C shared library, one of
...
const (
	templateVersion = "v5"
	libName         = "libtabnasmultisource"
	formatName      = "multisource"
	valueOut        = true
...
// newParser builds one engine with the multisource grammar installed
...
// parseWith answers whether src is in the multisource language — and,
